...
const emit = defineEmits(['input-pressed'])

function handleKeyDown(e: KeyboardEvent) {
  switch (e.key) {
    case 'ArrowUp':
      emit('input-pressed', Input.ArrowUp)
      break
    case 'ArrowDown':
      emit('input-pressed', Input.ArrowDown)
      break
    case 'ArrowLeft':
      emit('input-pressed', Input.ArrowLeft)
      break
    case 'ArrowRight':
      emit('input-pressed', Input.ArrowRight)
      break
    case 'a':
    case 'A':
      emit('input-pressed', Input.ButtonA)
      break
    case 'b':
    case 'B':
      emit('input-pressed', Input.ButtonB)
      break
    case 'Escape':
      emit('input-pressed', Input.Select)
      break
    case 'Enter':
      emit('input-pressed', Input.Start)
      break
    default:
      // ignore other keys
      return
...
<template>
  <svg
    ...
    enable-background="new -0.004 270.034 612.002 251.924"
    xml:space="preserve"
  >
    <switch>
      ...
      <g i:extraneous="self">
        <g>
          ...
          <rect
            ...
            height="50"
            fill="transparent"
            @click="emit('input-pressed', Input.ArrowUp)"
            style="cursor: pointer"
          />
          <!-- Transparent hitbox Arrow down -->
          <rect
            x="82"
            y="435"
            width="40"
            height="50"
            fill="transparent"
            @click="emit('input-pressed', Input.ArrowDown)"
            style="cursor: pointer"
          />
          <!-- Transparent hitbox Arrow left -->
          <rect
            x="35"
            y="400"
            width="50"
            height="40"
            fill="transparent"
            @click="emit('input-pressed', Input.ArrowLeft)"
            style="cursor: pointer"
          />
          <!-- Transparent hitbox Arrow right -->
          <rect
            x="118"
            y="400"
            width="50"
            height="40"
            fill="transparent"
            @click="emit('input-pressed', Input.ArrowRight)"
            style="cursor: pointer"
          />
          <!-- Transparent hitbox Select -->
          <rect
            x="210"
            y="430"
            width="60"
            height="40"
            fill="transparent"
            @click="emit('input-pressed', Input.Select)"
            style="cursor: pointer"
          />
          <!-- Transparent hitbox Start -->
          <rect
            x="295"
            y="430"
            width="60"
            height="40"
            fill="transparent"
            @click="emit('input-pressed', Input.Start)"
            style="cursor: pointer"
          />
          <!-- Transparent hitbox ButtonB -->
          <rect
            x="394"
            y="412"
            width="71"
            height="71"
            fill="transparent"
            @click="emit('input-pressed', Input.ButtonB)"
            style="cursor: pointer"
          />
          <rect
            x="474"
            ...
            height="71"
            fill="transparent"
            @click="emit('input-pressed', Input.ButtonA)"
            style="cursor: pointer"
          />
        </g>
      </g>
